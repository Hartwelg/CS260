...
//One Person is > another if last name is higher alphabetically, or if first name is higher given last names are equal
bool operator>(const Person& p1, const Person& p2);
//One person is < another if last name is lower alphabetically, or if first name is lower given last names are equal
bool operator<(const Person& p1, const Person& p2);
//Merge sort list helper
